...
<body>
    <header>
        ...
        <nav>
            ...
            <a href="./index.php" class="icons"> <i class='bx bxs-book-bookmark' ></i><a>
            <a href="./insert.php" class="icons"><i class='bx bxs-book-add'></i></a>
            <a href="./libro_delete.php" class="icons"><i class='bx bxs-book' ></i></a>
